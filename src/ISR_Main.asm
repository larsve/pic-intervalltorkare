...
#ifdef  __16F886
    movwf   W_save              ; save current W register contents
    swapf   STATUS, w           ; copy status register into W register
    movwf   STATUS_save         ; save contents of STATUS register
...
Init_MainISR
    ...
    ; Additional clearing of Interrupt Request flags might be nessecerry 
    ; depending on MCU, before enabling GIE
...
NoPir2Int
    ...
    movfw   PCLATH_save         ; Restore PCLATH register
    movwf   PCLATH
    swapf   STATUS_save, w      ; Restore STATUS register
    movwf   STATUS
